# poker44-miner-gen10heur3

Minimal release repository for model gen10heur3.

## Quick start

```bash
git clone https://github.com/tomkaba/poker44-miner-gen10heur3.git
cd poker44-miner-gen10heur3
python3 -m venv .venv
...
- Scorer is hardcoded to `gen10heur3`.
